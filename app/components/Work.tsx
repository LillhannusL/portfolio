...
export default function Work() {
	...
	return (
		<section id="work" className="mt-20 md:mt-60">
			...
			{/* <div className="flex gap-2 flex-wrap mb-10">
				{allTags.map((tag) => (
					<button
						...
						className={`font-mono hover:text-terracotta tracking-wider text-sm transition-colors border py-1 px-2 rounded-xl ${
							activeFilter === tag
