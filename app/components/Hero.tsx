...
export default function Hero() {
	...
	return (
		<section
			id="top"
			className="mt-20 md:mt-40 grid grid-cols-1 items-center md:grid-cols-2"
		>
			<div>
				...
				<div className="flex gap-4 md:gap-20 md:mt-20">
					...
					>
						Get in touch <IconArrowUpRight stroke={2} />
					</button>
				</div>
			</div>
			<div className="relative w-50 h-50 md:w-100 md:h-100 ml-20">
				<Image src={profile} alt="Lisa Lillhannus" className="object-cover" />
			</div>
		</section>
	);
}
