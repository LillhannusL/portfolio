      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="relative inline-flex flex-col items-center">
          <button
            ...
            className="flex items-center mx-auto gap-4 bg-terracotta py-3 px-6 rounded-full md:py-6 md:px-10 hover:bg-sage"
          >
          ...
          <span className="invisible mt-1 font-mono text-[11px] text-text-muted tracking-wide md:visible">
            Right-click to copy
          </span>
        </div>

        <div className="my-10 flex justify-center gap-6 md:mt-16 ">
          <button className="flex items-center gap-3 border border-text-soft py-2 px-4 rounded-full hover:text-terracotta transition-colors text-text-soft text-sm">
